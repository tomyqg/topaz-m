...
// 2 схема
//int color1rgbnormal[]={0xAB, 0x2B, 0x52};
//int color2rgbnormal[]={0xFF, 0x49, 0x00};
//int color3rgbnormal[]={0x00, 0xAF, 0x64};
//int color4rgbnormal[]={0x67, 0xE3, 0x00};

// 3 схема
//int color1rgbnormal[]={0x00, 0xC1, 0x2B};
//int color2rgbnormal[]={0x04, 0x85, 0x9D};
//int color3rgbnormal[]={0xFF, 0x7C, 0x00};
//int color4rgbnormal[]={0xFF, 0x52, 0x40};
